...
#     tk.Label(master, text=f"Luas : {txt_luas}").grid(row=7, columnspan=2)
...
#     txt_keliling = int(e1.get())+int(e2.get())+int(e3.get())
#     tk.Label(master, text=txt_alas).grid(row=9, columnspan=2)
#     tk.Label(master, text=txt_tinggi).grid(row=10, columnspan=2)
#     tk.Label(master, text=txt_sisimiring).grid(row=11, columnspan=2)
#     tk.Label(master, text=f"Keliling : {txt_keliling}").grid(row=12, columnspan=2)
...
#     txt_tinggi = "tinggi : %s"%(e2.get())
#     txt_luas = 0.5*int(e1.get())*int(e2.get())
#     tk.Label(master, text=txt_alas).grid(row=14, columnspan=2)
#     tk.Label(master, text=txt_tinggi).grid(row=15, columnspan=2)
#     tk.Label(master, text=f"Luas : {txt_luas}").grid(row=16, columnspan=2)
#     txt_sisimiring = "sisi miring : %s"%(e3.get())
#     txt_keliling = int(e3.get())+int(e3.get())+int(e3.get())
#     tk.Label(master, text=txt_sisimiring).grid(row=17, columnspan=2)
#     tk.Label(master, text=f"Keliling : {txt_keliling}").grid(row=18, columnspan=2)
# bt_show = tk.Button(master, text='Tampilkan semua', command=tampilkan_semua)
# bt_show.grid(row=13, column=0, sticky=tk.W, pady=4)
